...
```{r f_plot_diss-2, fig.wide=TRUE, echo=FALSE, include=TRUE, warning=FALSE, fig.width=12, fig.height=8}
set.seed(17)
...
```{r ari_plot_diss-2, fig.wide=TRUE, echo=FALSE, include=TRUE, warning=FALSE, fig.width=10, fig.height=7}
